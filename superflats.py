...
try:
    ...
    subprocess.run('ccs-script /home/ccd/ucd-scripts/ucd-data.py /home/ccd/ucd-scripts/eotest-configs/flat5000ADU_e2v.cfg',check=True, shell=True)
    subprocess.run('ccs-script /home/ccd/ucd-scripts/ucd-data.py /home/ccd/ucd-scripts/eotest-configs/bias_stability_e2v.cfg',check=True, shell=True)
    subprocess.run('ccs-script /home/ccd/ucd-scripts/ucd-data.py /home/ccd/ucd-scripts/eotest-configs/flat50000ADU_e2v.cfg',check=True, shell=True)
except:
    print("failure")
